...
const ANSWERS = {
  "q1": {
    "type": "text",
    "answers": [
      "When the person is in a different place",
      "unfamiliar environment, AND when they are alone."
    ]
  },
  "q2": {
    "type": "mc",
  ...
  "q5": {
    ...
    "answers": [
      ...
      "give a thorough assessment and support."
    ]
  },
  "q6": {
    "type": "text",
    "answers": [
      "Coping strategies means methods or techniques that help you deal with difficult situations or manage your feelings of anxiety."
    ]
  },
  "q7": {
    "type": "multi-text",
  ...
  "q8": {
    "type": "text",
    "answers": [
      "Because caffeine can increase feelings of nervousness and restlessness, which can make anxiety worse."
    ]
  },
  "q9": {
    "type": "text",
    "answers": [
      "To make unfamiliar environments feel safer and more manageable by creating a predictable structure."
    ]
  },
  "q10": {
    "type": "multi-text",
    "parts": {
      "q10a": [
        "Paragraph 5 focuses on breathing technique (deep breath), while paragraph 6 focuses on shifting focus away from distressing thoughts / doing relaxing activities."
      ],
      "q10b": [
        "Both are techniques to calm yourself down / both help manage feelings of discomfort or anxiety."
      ]
    }
  },
  "q11": {
    "type": "text",
    "answers": [
      "They might need someone to talk to for support",
      "they might feel unsafe or need a contact number for someone they can call."
    ]
  },
  "q12": {
    "type": "text",
    "answers": [
      "Listening to music",
      "performing simple mental tasks like word association or rhyming."
    ]
  },
  "q13": {
    "type": "text",
    "answers": [
      "It means that not getting enough sleep can make anxiety stronger",
      "worse, and can affect your ability to control your emotions."
    ]
  },
  "q14": {
    "type": "mc",
  ...
  "q15": {
    "type": "text",
    "answers": [
      "It suggests the passage is written in an advice column format, where a reader writes in with a problem and the writer answers",
      "gives advice."
    ]
  }
};
