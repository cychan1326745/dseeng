...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'Sunlight heats Earth’s surface unevenly; warm air rises and cool air flows to create wind currents.'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
    type: "text",
    answers: [
      'Wind turbine groups built out in the ocean'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'No greenhouse pollution; almost zero water consumption; land under turbines can still support wildlife/farming'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'Low power output on calm days; expensive energy storage; noise and landscape complaints / harm to flying animals'
    ]
  },
  q7: {
    type: "text",
  ...
  q8: {
    type: "text",
    answers: [
      '(i) subsidies (ii) fossil (iii) renewable (iv) warming'
    ]
  },
  q9: {
    type: "text",
  ...
  q10: {
    type: "text",
    answers: [
      'i) Difference: Offshore farms capture stronger ocean winds while land turbines have weaker air flow.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'Basic lighting and refrigerator power for village families'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Learn renewable energy at school; ask schools to install small wind turbines'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'The ground can be used for farming or growing wild plants.'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Fossil fuels are limited and create harmful carbon pollution, unlike wind power.'
    ]
  },
};
