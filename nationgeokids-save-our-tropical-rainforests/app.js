...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'Shallow warm equatorial seawater and steady sunlight'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
  ...
  q5: {
    type: "text",
    answers: [
      'Algae make food via photosynthesis and share nutrients with coral; corals provide a safe living space for algae.'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'Coral bleaching is when corals turn white after expelling their colour-producing algae, caused by rising seawater temperatures.'
    ]
  },
  q7: {
    type: "text",
  ...
  q8: {
    type: "text",
    answers: [
      '(i) bleaching (ii) nurseries (iii) zones / parks (iv) habitats'
    ]
  },
  q9: {
    type: "text",
    answers: [
      'Climate-related ocean warming; coastal plastic and chemical pollution; destructive fishing / boat anchor damage'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: Rainforests grow on land; coral reefs exist under the ocean.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'Reliable seafood food source; natural wave barriers that prevent coastal flooding'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Create protected marine zones; ban damaging fishing and boat anchor use near reefs'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'Cut single-use plastic consumption; buy sustainably harvested seafood'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Coral reefs have equally rich, diverse wildlife as tropical land rainforests.'
    ]
  },
};
