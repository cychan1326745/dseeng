...
const ANSWERS = {
  ...
  q3: {
    type: "text",
    answers: [
      'Fuel fees, car maintenance, parking charges and vehicle insurance'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'Stronger leg muscles, healthier heart, stable blood pressure'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'Shared electric bikes; rentable shared vans'
    ]
  },
  q7: {
    type: "text",
  ...
  q9: {
    type: "text",
    answers: [
      'Build safe separated bike lanes; lower transit fares for students/seniors; create car-free shopping zones'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: Private cars belong to individuals; shared bikes are borrowed publicly.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'Less vehicles on roads reduce traffic volume and avoid long delays.'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Walk short trips; take subway to school/work; join carpool for long journeys'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'Protect cyclists from fast-moving private cars.'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Private cars create pollution and traffic troubles; green transport is a better choice.'
    ]
  },
};
