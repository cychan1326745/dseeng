...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'It shortens people’s attention spans and reduces their ability to communicate face-to-face.'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
    type: "text",
    answers: [
      'Alyssa (a 19-year-old university student)'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'Digital minimalism (the idea of intentional, selective tech use instead of total tech bans)'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'They are used to fast short online content, so long texts feel dull.'
    ]
  },
  q7: {
    type: "text",
  ...
  q9: {
    type: "text",
    answers: [
      'Memorising vocabulary; printing photos for family sharing'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'Open student discussions about healthy digital habits / digital well-being lessons'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'It allows students to talk freely and realise their unhealthy online behaviour by themselves.'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'i) Difference: Strict bans forbid phones entirely while digital minimalism encourages controlled, purposeful tech use.'
    ]
  },
  ...
  q14: {
    type: "text",
    answers: [
      'Teenagers are overwhelmed and burdened by too much meaningless online content.'
    ]
  },
  q15: { type: "mc", answer: "B" },
};
