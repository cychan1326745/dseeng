...
const ANSWERS = {
  q1: { type: "text", answers: ["every spring before summer breeding season arrives", "in spring to attract mating partners"] },
  q2: { type: "mc", answer: "A" },
  q3: { type: "text", answers: ["ridged tongue and sharp spikes along the inside edge of their beak", "ridged tongue and sharp inner beak spikes"] },
  q4: { type: "multi-mc", parts: { q4i: "F", q4ii: "T", q4iii: "F" } },
  q5: { type: "text", answers: ["climate change warming oceans pushes fish away floating plastic ocean waste poisons puffins commercial overfishing removes their main food source", "ocean warming plastic pollution and overfishing"] },
  q6: { type: "text", answers: ["roughly forty days of shared incubation from both mother and father puffin", "around forty days"] },
  q7: { type: "text", answers: ["citizen"] },
  q8: { type: "multi-text", parts: { q8i: ["quotas"], q8ii: ["biologists"], q8iii: ["health"], q8iv: ["webs"] } },
  q9: { type: "text", answers: ["ban tourist visits to cliff nesting islands during breeding months set legal limits on commercial small fish catches organise volunteer beach plastic clean-up events", "ban tourists fishing quotas beach clean-ups"] },
  q10: { type: "multi-text", parts: { q10i: ["adult puffins have bright colourful beaks newly hatched chicks have plain grey fluffy feathers", "adults have colourful beaks chicks are grey"], q10ii: ["both rely on small ocean fish sand eels as their only food source", "both eat small fish"] } },
  q11: { type: "text", answers: ["up to sixty metres below the ocean surface", "60 metres", "sixty metres"] },
  q12: { type: "text", answers: ["join beach plastic clean-up teams take part in cliff puffin counting observation walks share bird population data with marine research scientists", "beach clean-ups count puffins share data"] },
  q13: { type: "text", answers: ["it warns that ocean fish numbers are falling or seawater temperatures are rising to dangerous levels", "signals shrinking fish stocks or rising temperatures"] },
  q14: { type: "mc", answer: "B" },
  q15: { type: "text", answers: ["puffins have bright colourful parrot-like beaks and make their breeding homes on cold rocky northern ocean cliff coastlines", "colourful beaks living on northern ocean cliffs"] }
};
