...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'Disposable shopping bags, food wrappers, single-use water bottles'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
  ...
  q5: {
    type: "text",
    answers: [
      'Small sea creatures eat microplastics, then larger sea predators eat those small creatures, and humans eat the predators as seafood.'
    ]
  },
  q6: {
    type: "text",
  ...
  q8: {
    type: "text",
    answers: [
      '(i) acidic (ii) packaging (iii) clean-up (iv) habitats'
    ]
  },
  q9: {
    type: "text",
    answers: [
      'Ban plastic bags and straws; charge extra fees for plastic packaging; ban plastic dumping at the seaside'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: Cloth bags can be reused many times while plastic bags are single-use waste.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'Bring reusable water bottles; buy fresh food without plastic wrapping / join beach clean-ups'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Governments pay large costs for workers to clean plastic rubbish from beaches.'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'Protected coastal sea areas where people cannot dump plastic waste'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Plastic waste slowly destroys ocean wildlife without people noticing the serious damage.'
    ]
  },
};
