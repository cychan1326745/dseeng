...
const ANSWERS = {
  q1: { type: "text", answers: ["on the western mountain slopes of californias sierra nevada mountain range usa", "california sierra nevada mountains"] },
  q2: { type: "mc", answer: "A" },
  q3: { type: "text", answers: ["heat from mild to moderate wildfires", "wildfire heat", "fire"] },
  q4: { type: "multi-mc", parts: {q4i: "F", q4ii: "T", q4iii: "F"} },
  q5: { type: "text", answers: ["fire suppression creates deadly intense wildfires tourist foot traffic compacts root zone soil climate change drought kills young saplings", "fire suppression soil compaction and drought"] },
  q6: { type: "text", answers: ["black bears spotted owls and flying squirrels", "bears owls and squirrels"] },
  q7: { type: "text", answers: ["keystone species"] },
  q8: { type: "multi-text", parts: {q8i: ["flow"], q8ii: ["charities"], q8iii: ["ecosystems"], q8iv: ["towns"]} },
  q9: { type: "text", answers: ["run regular controlled low-intensity prescribed burns build boardwalks around tree roots to avoid soil compaction plant fire-germinated saplings and mark off restricted grove borders", "prescribed burns boardwalks and replanting"] },
  q10: { type: "multi-text", parts: {q10i: ["mature sequoias are hundreds of metres tall and carry thousands of seed cones saplings are small slow-growing young trees", "mature trees are huge saplings are small"], q10ii: ["both have tannin-rich fire-resistant bark and shallow wide root systems anchored in mountain soil", "both have fire-resistant bark and wide roots"]} },
  q11: { type: "text", answers: ["up to 90 centimetres thick", "90 cm"] },
  q12: { type: "text", answers: ["hike only on official marked park trails share wildfire ecology knowledge with family donate to forest restoration charitable groups", "stay on trails share knowledge donate"] },
  q13: { type: "text", answers: ["unremoved thick underbrush creates extremely hot wildfires that burn through fireproof bark without mild heat seed cones stay closed and no new saplings grow", "underbrush buildup causes extreme fires and cones stay closed"] },
  q14: { type: "mc", answer: "B" },
  q15: { type: "text", answers: ["giant sequoias are the biggest living organisms on our planet by total trunk and foliage volume", "the largest living organisms on earth by volume"] }
};
