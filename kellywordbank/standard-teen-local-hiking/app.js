...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'Scrolling social media and playing mobile games'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
    type: "text",
    answers: [
      'Regular local hiking / hiking on weekends'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'It relieves stiff necks and back pain; it fixes irregular sleeping habits.'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'Hiking encourages real face-to-face cooperation while phone use isolates people.'
    ]
  },
  q7: {
    type: "text",
  ...
  q9: {
    type: "text",
    answers: [
      'Parents fear children get lost or injured; they worry hiking wastes exam revision time.'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: Hiking builds real offline friendship while online chats are shallow.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'Trips led by trained adult volunteers with first-aid kits; share real-time location; short beginner routes near transport.'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'To ensure students still have enough time to finish homework and revise after hiking.'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'Hiking lets teenagers leave the busy crowded urban environment and enjoy natural countryside scenery.'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Local teenagers live under heavy academic pressure and rarely get close to nature.'
    ]
  },
};
