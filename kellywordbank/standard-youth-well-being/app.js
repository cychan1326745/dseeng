...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'They think it is trivial, useless and takes away study time.'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
    type: "text",
    answers: [
      'Independent, self-directed unstructured play time without adult control'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'Wandering the city with friends without plans; playing basketball without scoring; making social media videos just for fun (any three)'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'It lets teens solve small troubles and overcome disappointment without adult help.'
    ]
  },
  q7: {
    type: "text",
  ...
  q9: {
    type: "text",
    answers: [
      'They worry low exam scores; they fear teens will be unsafe or form bad habits unsupervised.'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference Structured activities have fixed goals and adult judgement, unstructured play has no rules or evaluation.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'No electronic study devices are allowed during the one-hour play period.'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Cut unnecessary after-school training; organise outdoor group activities at lunch.'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'They concentrate better in class and feel less nervous before exams.'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Hong Kong’s exam-focused culture ignores how necessary free casual play is for young people’s development.'
    ]
  },
};
