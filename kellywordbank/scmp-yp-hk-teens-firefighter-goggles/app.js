...
const ANSWERS = {
  "q1": {
    "type": "text",
    "answers": [
      "The tragic blaze at Tai Po's Wang Fuk Court."
    ]
  },
  "q2": {
    "type": "mc",
  ...
  "q3": {
    "type": "text",
    "answers": [
      "The Made to Move Communities challenge."
    ]
  },
  "q4": {
    "type": "multi-mc",
  ...
  "q5": {
    "type": "text",
    "answers": [
      "(i) uses thermal cameras to guide users in low visibility, (ii) finds victims by scanning for Bluetooth signals, (iii) helps first responders find the best rescue routes, (iv) offers AI-powered emotional support."
    ]
  },
  "q6": {
    "type": "text",
    "answers": [
      "A prototype is an early model or test version of a product used to evaluate a design."
    ]
  },
  "q7": {
    "type": "multi-text",
    "parts": {
      "q7a": [
        "goggles (ii) signals (iii) emotional (iv) connection"
      ],
      "q7b": [
        ""
      ],
  ...
  "q8": {
    "type": "text",
    "answers": [
      "Because they felt the need to invent something specifically for firefighters after seeing the devastating fire."
    ]
  },
  "q9": {
    "type": "text",
    "answers": [
      "It is a contest that brought together more than 200 students to tackle real-world mobility issues."
    ]
  },
  "q10": {
    "type": "multi-text",
    "parts": {
      "q10a": [
        "One team won first place in Greater China (global co-champion, US$35,000), the other was second in Greater China (US$15,000)."
      ],
      "q10b": [
        "Both teams were from the same school (HKFYG Lee Shau Kee College)."
      ]
    }
  },
  "q11": {
    "type": "text",
    "answers": [
      "They said the tool would be helpful if it could be used as standard equipment for rescuers."
    ]
  },
  "q12": {
    "type": "text",
    "answers": [
      "(i) Bluetooth connection issues, (ii) hardware limits",
      "hosting a large AI model, (iii) making the device work without internet."
    ]
  },
  "q13": {
    "type": "text",
    "answers": [
      "A distress signal is a way for victims to alert first responders for help, sent from their smartphones without needing to unlock their devices."
    ]
  },
  "q14": {
    "type": "mc",
  ...
  "q15": {
    "type": "text",
    "answers": [
      "The title suggests that the goggles are a successful and award-winning invention that helps firefighters see through thick smoke, improving rescue operations."
    ]
  }
};
