...
const ANSWERS = {
  ...
  q3: {
    type: "text",
    answers: [
      'Teenagers playing music on city pavements for voluntary small donations'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'Live public practice fixes weak skills; performing under pressure improves overall musicality'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'Tourists, office workers and local elderly residents'
    ]
  },
  q7: {
    type: "text",
  ...
  q9: {
    type: "text",
    answers: [
      'Must apply for official permits; no loud music late at night; banned in busy shopping streets'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: Concerts sell expensive tickets; street music is free for everyone.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'To avoid blocking pedestrian movement in crowded shopping areas.'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Perform only 4–8 p.m.; use quiet speakers; keep pavements clear for walkers'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'Local youth mental health charity groups'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Street music is a valuable form of public urban art created by young people.'
    ]
  },
};
