...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'Severe exam anxiety and constant self-doubt'
    ]
  },
  q2: { type: "mc", answer: "A" },
  q3: {
    type: "text",
    answers: [
      'The moment Charlotte received counselling from her school social worker'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'Social media, offline workshops and peer storytelling sessions'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'Students find real personal stories much easier to understand and relate to long professional lectures with statistics.'
    ]
  },
  q7: {
    type: "text",
  ...
  q8: {
    ...
    parts: {
      q8i: ['stigma'],
      q8ii: ['narratives / stories'],
      q8iii: ['anonymous'],
      q8iv: ['embarrassment / gossip'],
    }
  },
  q9: {
    type: "text",
    answers: [
      'They think only severely mentally ill students need support; they fear classmates will judge them for sharing worries.'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: School lectures rely on cold statistics while the campaign uses real student personal stories.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'To let students release stress without feeling embarrassed or being gossiped about at school.'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Students’ two misunderstandings that stop them joining mental health workshops'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'A school environment where talking about mental health problems is normal and acceptable.'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Exam anxiety is a widespread, serious problem affecting many local teenagers.'
    ]
  },
};
