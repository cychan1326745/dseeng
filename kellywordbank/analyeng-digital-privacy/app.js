...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'Names, home addresses, school information and private chat records'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
    type: "text",
    answers: [
      'Detailed personal summaries built from collected user data'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'Targeted online fraud; cyberbullying via leaked private content'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'Open public profiles help users attract more online followers'
    ]
  },
  q7: {
    type: "text",
  ...
  q9: {
    type: "text",
    answers: [
      'Reuse simple passwords; share Wi-Fi with strangers; click unknown pop-up links'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference Public settings let all strangers view posts; private settings limit audiences.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'Know how their data is collected; delete stored personal information'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Do not post private locationschool info; turn off location tracking; use separate complex passwords'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'School classes teaching students how to protect online personal data'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Most teenagers do not realise the serious dangers of exposing personal data online.'
    ]
  },
};
