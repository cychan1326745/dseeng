...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'Local non-government organisations (NGOs) and district councils'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
    type: "text",
    answers: [
      'City residents have little access to green space and cannot grow vegetables themselves'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'It relieves stress; it helps neighbours build close social connections'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'Farming / outdoor planting activities with neighbours'
    ]
  },
  q7: {
    type: "text",
  ...
  q9: {
    type: "text",
    answers: [
      'They fear soil weight harms buildings; they worry water leakage damages structures'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: Screen time separates people while farming encourages neighbourly communication.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'Provide professional building safety checks; organise volunteer watering shifts for busy farmers'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Volunteers water crops when plot owners have no free time'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'The percentage of families who stop renting their planting plots'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Hong Kong is extremely crowded and short of natural green spaces for citizens to relax and grow food'
    ]
  },
};
