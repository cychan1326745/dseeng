...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'Selecting university subjects and taking part-time jobs'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
  ...
  q5: {
    type: "text",
    answers: [
      'Eat fruit instead of fried food; take short evening walks instead of scrolling phones'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'Teenagers prefer instant pleasure to long-term delayed benefits'
    ]
  },
  q7: {
    type: "text",
  ...
  q9: {
    type: "text",
    answers: [
      'Skip study videos daily; choose short fun over revision work'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: Instant fun gives immediate joy; healthy habits only bring future rewards.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'Tie new good actions to existing daily routines; set extremely easy tiny goals'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Read one page right after brushing teeth every morning'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'One single nice talk cannot build close bonds; steady small warm interactions grow friendship slowly.'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'People underestimate the long powerful influence of ordinary small daily decisions.'
    ]
  },
};
