...
const ANSWERS = {
  q1: { type: 'text', answers: ['the islands are extremely far from the mainland so species evolved separately and developed special survival traits', 'the islands are far from the mainland so species evolved separately', 'most species evolved separately developing special traits', 'because the islands are so far from the mainland most species evolved separately'] },
  q2: { type: 'mc', answer: 'B' },
  q3: { type: 'text', answers: ['lava lizards eat annoying flies that disturb resting sea lions', 'lava lizards eat flies that disturb sea lions', 'lava lizards eat insects that bother sea lions'] },
  q4: { type: 'multi-mc', parts: { q4i: 'NG', q4ii: 'F', q4iii: 'F' } },
  q5: { type: 'text', answers: ['plastic coastal pollution and invasive foreign animals eat native bird eggs', 'waste plastic pollutes coastlines and foreign animals eat native bird eggs', 'plastic pollution and invasive species'] },
  q6: { type: 'text', answers: ['sailors captured thousands of tortoises for meat on long sea journeys', 'sailors captured tortoises as fresh meat on long voyages', 'sailors captured thousands of tortoises to carry as fresh meat'] },
  q7: { type: 'text', answers: ['rangers', 'park rangers'] },
  q8: { type: 'multi-text', parts: { q8i: ['invaders', 'animals'], q8ii: ['tours'], q8iii: ['charities'], q8iv: ['species'] } },
  q9: { type: 'text', answers: ['visitors must take official guided tours no solo walking off marked paths all single-use plastic items are banned', 'join official guided tours cannot walk alone off marked paths single-use plastic banned', 'guided tours no solo walking no single-use plastic'] },
  q10: { type: 'multi-text', parts: { q10i: ['male boobies whistle while female boobies make honking noises', 'males whistle females make honking sounds'], q10ii: ['both dive at high speed to catch fish as food', 'both dive for food', 'both dive to catch fish'] } },
  q11: { type: 'text', answers: ['it creates local income and provides money for wildlife protection patrols', 'brings money to local communities and funds wildlife protection patrols', 'income for communities and funding for patrols'] },
  q12: { type: 'text', answers: ['learn about island wildlife refuse animal shell bone souvenirs donate to anti-poaching wildlife groups', 'learn about wildlife avoid animal souvenirs donate to charities'] },
  q13: { type: 'text', answers: ['tortoise groups on different islands have shells of distinct shapes', 'different islands have tortoises with differently shaped shells'] },
  q14: { type: 'mc', answer: 'B' },
  q15: { type: 'text', answers: ['the galapagos islands host many one-of-a-kind animal species that cannot be found anywhere else worldwide', 'the islands have unique wildlife found nowhere else on earth', 'it has unique wild animals that cannot be found anywhere else'] }
};
