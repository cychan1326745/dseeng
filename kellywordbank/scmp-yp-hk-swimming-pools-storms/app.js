...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'Lightning struck a diving platform at the Sha Tin Jockey Club Swimming Pool.\n    It shattered the corner edge and left a burn mark while swimmers were in the\n    water.'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
    type: "text",
    answers: [
      '"This" refers to the suggestion that supervisors should be empowered to\n    clear pools when early alerts are issued by the Hong Kong Observatory.'
    ]
  },
  q4: {
    type: "text",
    answers: [
      '(a) F (paragraph 2 says existing guidelines did NOT require public pools to\n        close)\n    (b) F (paragraph 4 says such measures could not guarantee full protection)\n    (c) T (paragraph 7 says pool managers monitored weather updates)'
    ]
  },
  q5: {
    type: "text",
    answers: [
      '(1) It often takes time to clear the pool.\n    (2) Swimmers need to queue for ladders, and some cannot hear the\n        announcements.'
    ]
  },
  q6: {
    type: "text",
    answers: [
      '"Underscoring" means highlighting / emphasising / demonstrating.'
    ]
  },
  q7: {
    type: "text",
  ...
  q8: {
    type: "text",
    answers: [
      'Because waiting for clear signs of rain, thunder and lightning causes\n    congestion at ladders and access points. Acting on early alerts would give\n    swimmers sufficient time to exit in an orderly manner.'
    ]
  },
  q9: {
    type: "text",
    answers: [
      'Increasing the number of lightning arresters, raising their height, and\n    ensuring all lighting poles around the pools are fitted with them.'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'Similarity: The chance of a football pitch or a swimming pool being struck\n     by lightning is similar.\n     Difference: A swimming pool poses a greater danger because water conducts\n     electricity, and a swimmer could drown if they lose consciousness from a\n     strike.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'Ho is concerned that water conducts electricity, so if a swimmer loses\n     consciousness from a lightning strike, they could drown.'
    ]
  },
  q12: {
    type: "text",
    answers: [
      '(1) Supervisors should be empowered to clear pools when early alerts are\n        issued by the Hong Kong Observatory.\n    (2) Authorities should step up public education to ensure people are aware\n        of the risks and get out of the water on their own.'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'Pool managers monitor weather updates. If the warning indicates that\n     thunderstorms would affect specific areas, swimmers must follow\n     instructions to seek shelter indoors and outdoor activities are suspended.'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'The title suggests the article is an educational reading comprehension\n     piece ("Study Buddy Explorer") that examines the debate in Hong Kong about\n     whether swimming pools should be closed during stormy weather.\n\n================================================================================'
    ]
  },
};
