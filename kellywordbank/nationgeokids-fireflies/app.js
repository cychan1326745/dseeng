...
const ANSWERS = {
  q1: { type: "text", answers: ["bioluminescence"] },
  q2: { type: "mc", answer: "A" },
  q3: { type: "text", answers: ["luciferin and luciferase"] },
  q4: { type: "multi-mc", parts: {q4i: "F", q4ii: "T", q4iii: "F"} },
  q5: { type: "text", answers: ["over-bright artificial light pollution toxic farm and garden pesticides draining wet marsh breeding habitats unregulated tourist trampling of egg-laying moss", "light pollution pesticides habitat loss and tourism"] },
  q6: { type: "text", answers: ["their bodies contain bitter toxic chemicals that taste unpleasant to predators", "they contain bitter poison"] },
  q7: { type: "text", answers: ["indicator species"] },
  q8: { type: "multi-text", parts: {q8i: ["habitats"], q8ii: ["biologists"], q8iii: ["ecosystems"], q8iv: ["wildlife"]} },
  q9: { type: "text", answers: ["install dim low-light street lamps near wetlands ban toxic chemical pesticide sprays run controlled firefly tours with no-flash photo rules and restricted nesting zones", "dim lights ban pesticides controlled tours"] },
  q10: { type: "multi-text", parts: {q10i: ["adults fly through dusk air to flash mating signals larvae live underground hunting snails and worms", "adults fly larvae live underground"], q10ii: ["both produce glowing bioluminescent light to warn predators of bitter poison", "both glow to warn predators"]} },
  q11: { type: "text", answers: ["only two to four weeks", "2-4 weeks"] },
  q12: { type: "text", answers: ["count firefly flash groups each summer send population data to insect scientists join regulated low-impact firefly-watching tours", "count fireflies share data join tours"] },
  q13: { type: "text", answers: ["intense man-made light drowns out their faint mating flash signals so males and females cannot locate each other", "artificial light blocks mating signals"] },
  q14: { type: "mc", answer: "B" },
  q15: { type: "text", answers: ["fireflies are tiny wild insects that naturally create soft glowing light after sunset without electricity", "tiny insects that naturally glow at night"] }
};
