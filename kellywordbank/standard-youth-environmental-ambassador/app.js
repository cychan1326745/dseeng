...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'Urban construction, river pollution and discarded plastic waste'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
    type: "text",
    answers: [
      'The Young Environment Ambassador (YEA) programme'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'To show locals and tourists Hong Kong’s diverse native wildlife that people usually ignore'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'Held free wildlife sharing workshops; taught kids methods to protect wild creatures'
    ]
  },
  q7: {
    type: "text",
  ...
  q9: {
    type: "text",
    answers: [
      'Limited number of trainers restricts yearly intake; many students quit during mock exam periods'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: School lessons talk about global climate abstractly while YEA teaches local environmental troubles.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'It is too general and lacks local wildlife field learning opportunities.'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'They will develop lasting responsibility to protect Hong Kong’s natural environment.'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'Reduce single-use plastic; join local environmental clean-up events'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Hong Kong’s native plants and animals are disappearing and need teenagers’ protection.'
    ]
  },
};
