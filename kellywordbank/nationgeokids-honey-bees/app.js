...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'Most fruit, vegetable and wild flower plants cannot grow seeds and reproduce.'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
    type: "text",
    answers: [
      'Bees transferring pollen between male and female flower parts / pollination'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'Collect nectar and pollen; build honeycombs / clean and guard the hive'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'A distance equal to travelling all the way around the Earth twice'
    ]
  },
  q7: {
    type: "text",
  ...
  q9: {
    type: "text",
    answers: [
      'Harmful farm pesticides, parasitic mites, lost wild flower habitats, extreme climate weather'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: Queen bees lay eggs while drones only mate with new queens.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'The prices of fresh fruit and vegetables will increase quickly.'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Plant native wildflowers; avoid chemical insect sprays; support organic local farmers / join community urban beekeeping.'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'Bees get safe homes and flower food from humans, and humans get plenty of food crops via bee pollination.'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Honey bees are extremely important to all living things and the global food system.'
    ]
  },
};
