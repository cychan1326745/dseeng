...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'Worse exam grades, poor sleep quality and weaker face-to-face communication skills'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
    type: "text",
    answers: [
      'Teenagers’ unhealthy overuse of digital screens and online platforms'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'Share private information publicly; get distracted by online games during homework'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'Pop-up game and social media notifications'
    ]
  },
  q7: {
    type: "text",
  ...
  q9: {
    type: "text",
    answers: [
      'Monthly class discussions about online risks; free after-school workshops led by IT social workers'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: Phone bans only restrict device use, while digital lessons teach students to use tech wisely.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'They learn to separate useful online content from meaningless short video clips.'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Teenagers spending too much time on digital screens every day'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'Young people lack the ability to judge right and wrong online.'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Simple screen time limits cannot fully solve teen online addiction problems.'
    ]
  },
};
