...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'Savanna elephants (grassland type) and forest elephants (woodland type)'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
  ...
  q5: {
    type: "text",
    answers: [
      'Grab food; suck drinking water; spray dust on skin; lift heavy tree branches'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'An elder female matriarch; she remembers safe water spots and traditional migration paths.'
    ]
  },
  q7: {
    type: "text",
  ...
  q8: {
    type: "text",
    answers: [
      '(i) matriarchs (ii) seeds (iii) reserves (iv) income'
    ]
  },
  q9: {
    type: "text",
    answers: [
      'Illegal ivory poaching; destruction of wild elephant habitats for farmland'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: Adult elephants have full-length ivory tusks while calves have none.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'They dig deep holes with tusks to find underground water pools for all wildlife.'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Global ivory trade bans; anti-hunting patrols in wildlife parks; eco-tourism village projects'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'Eco-tourism from visitors watching wild elephants'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'African elephants are huge, peaceful creatures that play an irreplaceable role in Africa’s natural ecosystems.'
    ]
  },
};
