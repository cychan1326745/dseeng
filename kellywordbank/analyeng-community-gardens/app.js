...
const ANSWERS = {
  ...
  q3: {
    type: "text",
    answers: [
      'Natural plant nutrients made from recycled restaurant food waste'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'It eases heavy daily stress; it helps neighbours build close friendships'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'Teens learn the whole growth process of vegetables and know food waste can become fertiliser'
    ]
  },
  q7: {
    type: "text",
  ...
  q8: {
    ...
    parts: {
      ...
      q8ii: ['abandon'],
      q8iii: ['shifts'],
      q8iv: ['produce / vegetables'],
    }
  },
  q9: {
    type: "text",
    answers: [
      'They fear soil weight damages walls; they worry water leakage cracks building structures'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: Phones isolate people; group planting creates neighbour communication.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'Professional building safety examinations; volunteer watering teams for busy growers'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Three hours maximum each weekend'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'Skills to grow vegetables naturally and reuse food waste without chemicals'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Dense crowded cities lack natural green spaces that benefit residents’ well-being.'
    ]
  },
};
