...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'The academic transcripts of Eileen Chang / the trowel used to lay the\n    foundation of HKU\'s oldest building. (Accept either or both.)'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
    type: "text",
    answers: [
      '"It" refers to the university coat of arms / possessing the coat of arms.'
    ]
  },
  q4: {
    type: "text",
    answers: [
      '(a) F (paragraph 7 says archives are different from libraries; archives are\n        not accessible via open stacks)\n    (b) F (paragraph 12 says they had no idea she would become famous; they\n        kept it simply for maintaining the record)\n    (c) F (paragraph 14 says the city lacks dedicated postgraduate programmes\n        in archival management)'
    ]
  },
  q5: {
    type: "text",
    answers: [
      '(1) It provides a verifiable account of past transactions and decisions.\n    (2) It ensures the organisation is curating its institutional memory.'
    ]
  },
  q6: {
    type: "text",
    answers: [
      '"Veracity" means truthfulness / accuracy / truth.'
    ]
  },
  q7: {
    type: "text",
  ...
  q8: {
    type: "text",
    answers: [
      'Because it represents a pinnacle of achievement for the university, it\n    symbolises HKU\'s heritage as a mix of East and West, and it is portable.'
    ]
  },
  q9: {
    type: "text",
    answers: [
      'The common misconception is that archives are like museums. In reality,\n    archives are about records management for their own institution, and they\n    do not collect material from other institutions.'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'Similarity: Both archives and libraries hold collections of materials.\n     Difference: In a library, the same book can be found in many different\n     libraries, but a specific file in an archive exists only in that one place.\n     Also, library materials are accessible via open stacks, while archive\n     records are irreplaceable and not openly accessible.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'Loong is concerned that the pace of change in AI and other fields is\n     incredibly fast, whereas archival work is the opposite – it is slow. He\n     sees the slowness as having a profound benefit because it preserves\n     authenticity and veracity.'
    ]
  },
  q12: {
    type: "text",
    answers: [
      '(1) A genuine interest in history\n     (2) A passion for "searching for the needle" / a sense of social\n         responsibility / the belief that records can help people'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'The Swedish family came to see their late son\'s thesis. It was an\n     emotional moment because they saw his original signature on the final\n     submission. Finding his dissertation in a professional archive abroad meant\n     a lot to them.'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'The title suggests the article explains how archivists correct\n     misunderstandings ("set the record straight") about their profession while\n     also literally preserving records, and how their work of preserving items\n     helps tell the story of the institution they serve.\n\n================================================================================'
    ]
  },
};
