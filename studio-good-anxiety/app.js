...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'Racing thoughts, sleepless nights and heavy pressure'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
    type: "text",
    answers: [
      'The natural anxious feeling that reminds people to prepare for goals'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'Poor sleep, weakened memory, loss of interest in hobbies'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'Clearly name your worries; write fears down on paper'
    ]
  },
  q7: {
    type: "text",
  ...
  q9: {
    type: "text",
    answers: [
      'Organise student sharing sessions; avoid public comparison of exam scores'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: Mild anxiety pushes preparation; severe anxiety stops study and social life.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'Huge exam content feels overwhelming, while small daily tasks are less stressful.'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Short outdoor walks; listening to soft music'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'They study non-stop without any rest breaks.'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Anxiety has both bad and useful sides instead of being only harmful.'
    ]
  },
};
