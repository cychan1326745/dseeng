...
const ANSWERS = {
  "q1": {
    "type": "text",
    "answers": [
      "He is a security guard (who works the graveyard shift at a railway station)."
    ]
  },
  "q2": {
    "type": "mc",
  ...
  "q3": {
    "type": "text",
    "answers": [
      "Sato's solution of making signage out of duct tape."
    ]
  },
  "q4": {
    "type": "multi-mc",
  ...
  "q5": {
    "type": "text",
    "answers": [
      "Nintendo and Suntory (also accepted: Nike)."
    ]
  },
  "q6": {
    "type": "text",
    "answers": [
      "A septuagenarian is a person who is in their seventies (70-79 years old)."
    ]
  },
  "q7": {
    "type": "multi-text",
    "parts": {
      "q7a": [
        "signs/signage (ii) typography (iii) rounded (iv) fee"
      ],
      "q7b": [
        ""
      ],
  ...
  "q8": {
    "type": "text",
    "answers": [
      "He was asked to help travellers navigate the crowded Shinjuku Station during renovations."
    ]
  },
  "q9": {
    "type": "text",
    "answers": [
      "Shuetsu-tai is Sato's unique typography style, characterised by rounded edges designed to soothe commuters' irritation."
    ]
  },
  "q10": {
    "type": "multi-text",
    "parts": {
      "q10a": [
        "Sato is a security guard by training, not a trained graphic designer / artist. / Sato uses only duct tape."
      ],
      "q10b": [
        "Both create signs and lettering / both have a passion for creating."
      ]
    }
  },
  "q11": {
    "type": "text",
    "answers": [
      "He was blown away by Sato's cool, powerful lettering and his incredible passion and strong desire to create."
    ]
  },
  "q12": {
    "type": "text",
    "answers": [
      "(i) meals to be provided while he works, (ii) transport costs to be covered."
    ]
  },
  "q13": {
    "type": "text",
    "answers": [
      "Duct tape signage is signs made by sticking coloured duct tape onto walls to form directions, letters and designs."
    ]
  },
  "q14": {
    "type": "mc",
  ...
  "q15": {
    "type": "text",
    "answers": [
      "The title suggests that Sato, despite being a security guard with no formal art training, creates highly valued and famous signs using simple duct tape."
    ]
  }
};
