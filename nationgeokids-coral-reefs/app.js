...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'Shallow seawater with warm temperatures and enough sunlight'
    ]
  },
  q2: { type: "mc", answer: "A" },
  q3: {
    type: "text",
    answers: [
      'The nickname “the rainforests of the sea”'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'Algae make food for coral while coral provides a safe living space for algae.'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'Coral bleaching is when corals turn white because warm water makes them release their colour-giving algae.'
    ]
  },
  q7: {
    type: "text",
  ...
  q9: {
    type: "text",
    answers: [
      'Rising sea temperatures from climate change; chemical and plastic pollution; boat damage and destructive fishing'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: Rainforests are land ecosystems while coral reefs live under the ocean.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'People lose a key seafood food supply; coasts lose natural wave barriers against floods and typhoons.'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Create protected marine parks; ban harmful fishing and boat activities near reefs.'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'Cut down single-use plastic products; buy sustainably caught seafood.'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Coral reefs have the same rich, diverse wildlife as tropical rainforests on land.'
    ]
  },
};
