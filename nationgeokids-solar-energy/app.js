...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'They release carbon pollution that warms the planet; they waste large amounts of cooling water and destroy wildlife habitats.'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
    type: "text",
    answers: [
      'Small units inside solar panels that turn sunlight into electric current'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'No greenhouse gas output; nearly zero water consumption; little damage to wild natural areas'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'Solar panel manufacturing and installation costs were extremely high in the past.'
    ]
  },
  q7: {
    type: "text",
  ...
  q9: {
    type: "text",
    answers: [
      'Weak power during cloudy/winter days; expensive large storage batteries; shaded urban rooftops cannot fit panels'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: Solar creates no carbon pollution while coal burning releases harmful greenhouse gases.'
    ]
  },
  q11: {
    type: "text",
  ...
  q12: {
    type: "text",
    answers: [
      'Build solar power fields on empty playgrounds; learn renewable energy knowledge at school.'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'Help the whole world stop using polluting fossil fuels.'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Fossil fuels are dirty and will be replaced by clean solar energy in the future.'
    ]
  },
};
