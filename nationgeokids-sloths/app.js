...
const ANSWERS = {
  ...
  q3: {
    type: "text",
    answers: [
      'Soft tree leaves, young shoots and ripe fruit'
    ]
  },
  q4: {
    type: "multi-mc",
  ...
  q5: {
    type: "text",
    answers: [
      'Their leaf-based diet provides very little energy, so slow movement saves energy.'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'They become easy prey for wild predators and illegal animal hunters.'
    ]
  },
  q7: {
    type: "text",
  ...
  q9: {
    type: "text",
    answers: [
      'Rainforest tree clearing for farms; illegal capture for exotic pet sales'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: Baby sloths stick to mothers to learn survival skills; adults live independently in trees.'
    ]
  },
  q11: {
    type: "text",
  ...
  q12: {
    type: "text",
    answers: [
      'Refuse sloth pets/wildlife souvenirs; pick eco-friendly tour companies; donate to rainforest reforestation groups.'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'Curved claws grip tree branches well but make dragging across ground exhausting and slow.'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Sloths are creatures that spend almost their whole lives living inside tropical rainforest canopies.'
    ]
  },
};
