...
const ANSWERS = {
  q1: { type: "text", answers: ["lime-green backs orange webbed feet blue striped sides and large bright red eyes", "green back orange feet blue sides red eyes"] },
  q2: { type: "mc", answer: "B" },
  q3: { type: "text", answers: ["their thin moist skin absorbs oxygen from humid air and cannot survive dry hot conditions", "they need humid air to breathe through their skin"] },
  q4: { type: "multi-mc", parts: {q4i: "F", q4ii: "T", q4iii: "F"} },
  q5: { type: "text", answers: ["when disturbed they suddenly flash all bright colours shocking predators long enough for the frog to escape", "sudden bright flash shocks predators giving time to escape"] },
  q6: { type: "text", answers: ["rainforest deforestation for farms farm pesticide stream pollution longer dry seasons from climate change", "deforestation pesticides and climate change"] },
  q7: { type: "text", answers: ["indicator species"] },
  q8: { type: "multi-text", parts: {q8i: ["reserves"], q8ii: ["ecosystems"], q8iii: ["clusters"], q8iv: ["habitats"]} },
  q9: { type: "text", answers: ["create protected rainforest reserves volunteer native tree sapling replanting regulated quiet guided rainforest wildlife walks", "reserves replanting and guided walks"] },
  q10: { type: "multi-text", parts: {q10i: ["adult frogs live high in tree foliage tadpoles live underwater in forest streams", "adults in trees tadpoles in water"], q10ii: ["both rely on healthy humid undamaged rainforest environments to survive", "both need healthy rainforest"]} },
  q11: { type: "text", answers: ["on the bottom side of leaves hanging over shallow rainforest streams", "under leaves overhanging streams"] },
  q12: { type: "text", answers: ["suction-cup toe pads for climbing smooth leaves thin moist skin that takes oxygen from humid tree air", "suction toes and moist skin"] },
  q13: { type: "text", answers: ["it tells scientists the whole rainforest ecosystem has become unbalanced and polluted", "signals unbalanced rainforest ecosystem"] },
  q14: { type: "mc", answer: "B" },
  q15: { type: "text", answers: ["the red-eyed tree frog has extremely striking vivid multi-coloured skin that stands out against green rainforest leaves", "bright colourful frog that stands out in the rainforest"] }
};
