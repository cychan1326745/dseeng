...
const ANSWERS = {
  ...
  q4: {
    type: "text",
    answers: [
      'simple low-tech offline pastimes / playing physical board games without computers'
    ]
  },
  q5: {
    type: "text",
    answers: [
      'One month before the article was published (The Nation 1st May 2011)'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'Pat was a university business-management graduate; Dee worked alongside Pat, they collected old board games from storage before launching the cafe. They also run a Chinese-language school called Learning East.'
    ]
  },
  q7: { type: "mc", answer: "B" },
  q8: {
  ...
  q10: {
    type: "text",
    answers: [
      'Any board game purchased from the cafe'
    ]
  },
  q11: { type: "mc", answer: "D" },
  q12: {
    type: "text",
    answers: [
      ''
