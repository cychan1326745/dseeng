...
const ANSWERS = {
  q1: {
    type: "text",
    answers: [
      'It produces massive textile waste and wastes enormous volumes of fresh water for cotton production.'
    ]
  },
  q2: { type: "mc", answer: "B" },
  q3: {
    type: "text",
    answers: [
      'Shopping for second-hand clothes / second-hand shopping'
    ]
  },
  q4: {
    type: "text",
  ...
  q5: {
    type: "text",
    answers: [
      'People think second-hand clothes are dirty and out-of-style / only affordable for low-income groups (any two)'
    ]
  },
  q6: {
    type: "text",
    answers: [
      'A false, mistaken belief or misunderstanding'
    ]
  },
  q7: {
    type: "multi-text",
  ...
  q8: {
    type: "text",
    answers: [
      'Manufacturing brand-new cotton shirts consumes thousands of litres of water, so reusing old ones avoids this water waste.'
    ]
  },
  q9: {
    type: "text",
    answers: [
      'Frequently buying lots of cheap second-hand clothes, wearing them briefly then throwing them away.'
    ]
  },
  q10: {
    type: "text",
    answers: [
      'i) Difference: Responsible thrifting buys durable long-term items, while fast thrifting creates new waste by discarding clothes quickly.'
    ]
  },
  q11: {
    type: "text",
    answers: [
      'It recreates the waste cycle that second-hand culture was designed to eliminate.'
    ]
  },
  q12: {
    type: "text",
    answers: [
      'Shop for timeless long-lasting clothing; donate unwanted garments to charity / join free clothing swap events (any two)'
    ]
  },
  q13: {
    type: "text",
    answers: [
      'A free community activity where teenagers exchange unwanted clothes without paying money.'
    ]
  },
  ...
  q15: {
    type: "text",
    answers: [
      'Fast fashion damages the environment and lacks an eco-friendly solution on its own.'
    ]
  },
};
